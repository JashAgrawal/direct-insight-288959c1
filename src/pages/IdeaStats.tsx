...
export default function IdeaStats() {
  ...
  const { submittedIdea } = useAuthStore();
  ...
  const stats = [
    ...
    },
    {
      ...
      value: totalAgentInteractions,
      icon: Users,
      color: 'text-foreground',
    },
    {
      label: 'AVG AGENTS/IDEA',
      value: avgAgentsPerIdea,
      icon: Clock,
      ...
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="border border-border p-6">
          ...
          <p className="text-sm font-mono text-muted-foreground">
            Oracle-approved ideas and agent activity
          </p>
        </div>
        ...
        {submittedIdea && (
          <div className="border border-border p-6 space-y-4">
            <h2 className="text-lg font-mono font-bold text-foreground">
              ORACLE-APPROVED IDEA
            </h2>
            <div className="bg-muted p-4">
              <p className="text-sm font-mono">{submittedIdea}</p>
            </div>
          </div>
        )}
